...
👉 Deploy your fork and open `https://<username>.github.io/<repo>/`
...
10. Set up GitHub pages: Go to your own repo -> Settings -> Pages. In `Build and deployment`, set `Source="Deploy from a branch"` and choose your repository default branch with folder `/(root)`. Wait for a few minutes, then open `https://<username>.github.io/<repo>/`.

# Plans
Use your own GitHub Projects board or issue tracker if you want to keep a roadmap for your fork.
